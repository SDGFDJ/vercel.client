...
const EditProductAdmin = ({ close, data: propsData, fetchProductData }) => {
  const [data, setData] = useState({
    ...
    unit: propsData.unit || 'pack', // Default to 'pack' for fixed products
    productType: propsData.productType || 'fixed', // Default to 'fixed'
        ...
        <section className=''>
          ...
          <div className='grid p-3'>
            <form className='grid gap-4' onSubmit={handleSubmit}>
              ...
              <div className='grid gap-1'>
                <label htmlFor='productType' className='font-medium'>Product Type</label>
                <select
                  id='productType'
                  name='productType'
                  ...
                  className='bg-blue-50 p-2 outline-none border focus-within:border-primary-200 rounded'
                >
                  <option value='fixed'>Fixed (e.g., Pack/Piece)</option>
                  <option value='variable'>Variable (e.g., kg, litre, gm, ml)</option>
                </select>
              </div>
              <div className='grid gap-1'>
              ...
              <div className='grid gap-1'>
                <label htmlFor='price' className='font-medium'>Price {data.productType === 'variable' ? '(per unit)' : '(per piece)'}</label>
                <input
                  id='price'
                  type='number'
