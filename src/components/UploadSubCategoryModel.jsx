...
const UploadSubCategoryModel = ({ close, fetchData }) => {
  ...
  const handleAddCategory = (value) => {
    ...
    setSubCategoryData(prev => {
      const newCategories = [...prev.category, categoryDetails];
      // Remove duplicates
      const uniqueCategories = Array.from(new Map(newCategories.map(c => [c._id, c])).values());
      return { ...prev, category: uniqueCategories };
    });
  };
        ...
        <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
          ...
          <div className='grid gap-1'>
            ...
            <div className='border focus-within:border-primary-200 rounded'>
              ...
              {/* Dropdown */}
              <select className='w-full p-2 bg-transparent outline-none border' onChange={e => handleAddCategory(e.target.value)}>
