...
const Header = () => {
  ...
  return (
    <>
      {/* ✅ SEO */}
      <Helmet>
        <title>Nexebay | Fashion & More</title>
        <meta
          name="description"
          content="Nexebay is your one-stop fashion & lifestyle online store. Shop trending products, check your wishlist, and add to cart seamlessly."
        />
        <meta
          name="keywords"
          content="Nexebay, online shopping, fashion, clothes, accessories, wishlist, cart"
        />
      </Helmet>
